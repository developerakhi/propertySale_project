                                ...
                                <tbody>
                                  ...
                                  <tr>
                                    ...
                                    <td class="text-right footable-last-visible" style="display: table-cell;">
                                      ...
                                      <a href="{{route('location.destory', $items->id)}}" class="btn btn-soft-danger btn-icon btn-circle btn-sm " title="Delete">
            ...
            <div class="col-5">
              <div class="card">
                  <div class="card-body">
                      <div class=row>
                          <div class="col-md-6 col-sm-4 col-lg-12">
                              <form role="form" action="{{route('location.store')}}" method="POST" enctype="multipart/form-data">
                                @csrf
                              <div class="row mb-4">
                                <div class="col">
                                  <div class="form-outline">
                                    <label for="location_name">Create Location</label>
                                    <input type="text" name="location_name" id="location_name" class="form-control" value="" required placeholder="location name" />
                                  </div>
                                </div>
                              </div>
                                <!-- Submit button -->
...
<script type="text/javascript">
  $('body').on('click','.edit', function(){
    let id=$(this).data('id');
    $.get("location/edit/"+id, function(data){
